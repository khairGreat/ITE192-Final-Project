...
if __name__ == "__main__":
    # WARNING: Stop MySQL before restoring
    # restore_result = restore_raw_backup(
    #     backup_folder_path="raw_backups/testdb3_backup_20250526_232747_2578",
    #     db_name="testdb3",
    #     xampp_path=r"C:\New Folder"
    # )
    # print(restore_result)
    # After this, start MySQL again to see the restored database.
